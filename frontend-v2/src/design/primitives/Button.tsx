...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium transition-all duration-150 active:scale-[0.97] focus:outline-none focus-visible:outline-none focus:ring-2 focus-visible:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
