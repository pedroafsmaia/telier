...
async function run() {
  ...
  try {
    ...
    if (hasLogin) {
      ...
      await page.fill('#l-login', LOGIN_USER);
      await page.fill('#l-senha', LOGIN_PASS);
      await page.click('#btn-login');
    }

    await page.waitForSelector('#page-app:not(.hidden), .dash-toolbar, #cards-grid-dash', { timeout: TIMEOUT });
